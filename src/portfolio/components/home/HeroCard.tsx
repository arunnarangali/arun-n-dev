...
export const HeroCard = ({ variants }: HeroCardProps) => {
  return (
    <motion.div
      variants={variants}
      className="flex flex-col justify-center space-y-8 rounded-[2.5rem] border border-outline-variant bg-surface-container-low p-5 shadow-2xl @sm:p-8 @5xl:p-14"
    >
      <div className="space-y-4 @3xl:space-y-6">
        ...
        <h1 className="text-2xl font-black leading-[1.1] tracking-tighter @xs:text-3xl @3xl:text-4xl @5xl:text-5xl @6xl:text-6xl">
          <TypingName />
        </h1>
      ...
      <div className="flex flex-col gap-3 @xs:flex-row @sm:gap-4">
        {heroContent.ctas.map((cta) => (
          <a
            ...
            href={cta.href}
            className={[
              'inline-flex items-center justify-center rounded-xl border px-4 py-3 text-xs font-black tracking-wide transition-all shadow-lg @sm:px-6 @3xl:px-8 @3xl:py-3.5 @3xl:text-sm',
              cta.variant === 'ghost'
