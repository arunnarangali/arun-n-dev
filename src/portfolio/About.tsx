...
export const AboutSection = () => {
  return (
    <section className="mx-auto grid w-full max-w-5xl gap-8 rounded-2xl border border-outline-variant bg-surface-container-low p-6 text-on-surface md:grid-cols-[260px,1fr] md:p-8">
